...
namespace Nvspromo\ZohoOrderHistory\Block\Open;
...
class OrderHistory extends \Magento\Framework\View\Element\Template
{
    ...
    public function getOrders(){
        ...
        if ($customersession->isLoggedIn()) {
            ...
            $url = "https://www.zohoapis.com/crm/v2/Sales_Orders/search?page=1&per_page=20&criteria=((EMail:equals:".$email."))";
            $sales_orders_result = $this->sendCurl($url,$token_header);
            if (isset($sales_orders_result)) {
                return $sales_orders_result['data'];   
            } else {
                return '';
            }
        }
